...
class CfgEpochClient
{
	...
	outOfBoundsRadiation = 2; // how much rads per tick (10sec), when outside play area.
	...
	radiatedObjMaxFalloutDist = 25; // max distance radiated object can affect player (number in meters)
    ...
    disableRemoteSensors = "false";  // disableRemoteSensors true/false
